...
function ExampleOverlayView({ styles }: MapProps): JSX.Element {
    ...
    const loadCallback = useCallback((e: google.maps.OverlayView) => {
        console.log('OverlayView onLoad: ', e)
    }, [])

    const unmountCallback = useCallback((e: google.maps.OverlayView) => {
